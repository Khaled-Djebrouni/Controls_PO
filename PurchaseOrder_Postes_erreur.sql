...
/****** Object:  View [dbo].[contrôle_PurchaseOrder_Postes_erreur]    Script Date: 05.02.2024 8:39:41 ******/
SET ANSI_NULLS ON
GO
...
CREATE view   [dbo].[contrôle_PurchaseOrder_Postes_erreur] as 
select * from contrôle_PurchaseOrder_Postes where
